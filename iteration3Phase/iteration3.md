...
* Reason 2: edU uses image validation created by the developers, eliminating the need for tracing over a preshown object. This allows creativity and the chance to execute their own unique writing styles.
